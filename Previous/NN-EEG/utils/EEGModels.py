"""
 ARL_EEGModels - A collection of Convolutional Neural Network models for EEGNet
 ...
 To run the EEGNet/MEG ERP classification sample script, you will also need
...
def EEGNet_old(nb_classes, Chans = 64, Samples = 128, regRate = 0.0001,
    ...
    Inputs:
        ...
        Chans, Samples : number of EEGNet channels and samples, respectively
...
def DeepConvNet(nb_classes, Chans = 64, Samples = 256,
    ...
    This implementation assumes the input is a 2-second EEGNet signal sampled at
...
def ShallowConvNet(nb_classes, Chans = 64, Samples = 128, dropoutRate = 0.5):
    ...
    Assumes the input is a 2-second EEGNet signal sampled at 128Hz. Note that in
    the original paper, they do temporal convolutions of length 25 for EEGNet

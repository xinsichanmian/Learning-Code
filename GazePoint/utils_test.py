...
def normlize2(rot_frame,rot_points,eye_shape,face_shape):
    ...
    lefteyeImg = CropImg(rot_frame,
                               ...
                               leftbox.width,
                               leftbox.height)
    lefteyeImg = cv2.resize(lefteyeImg, eye_shape)   #(60, 36)
    ...
    righteyeImg = CropImg(rot_frame,
                                ...
                                rightbox.width,
                                rightbox.height)
    righteyeImg = cv2.resize(righteyeImg, eye_shape)
    ...
    faceImg = CropImg(rot_frame,
                            ...
                            facebox.width,
                            facebox.height)
    faceImg = cv2.resize(faceImg, face_shape)   #(224, 224)
